...
<div class="container">
    ...
    <h2 class="center">TikTok Video Downloader</h2>
    <form id="downloadForm">
        <div class="input-container">
            <input type="text" id="videoUrl" name="url" placeholder="Enter TikTok Video URL" required>
    ...
    <div class="scannedby">
        {{-- <h3>TikTok Reels Downloader</h3> --}}
        <p>Easily download your favorite TikTok Reels with our free and intuitive online downloader.</p>
        <p>Save inspiring and engaging videos directly to your device for offline viewing or sharing.</p>
    </div>

    <div class="howtouse">
        <h3>How to Use the TikTok Reels Downloader</h3>
        <div class="steps-container">
            <div class="step-card">
                <i class="fas fa-link"></i>
                <p><strong>1. Find and Copy URL:</strong> Copy the URL of the TikTok Reel you wish to download.</p>
            </div>
            <div class="step-card">
    ...
    <div class="whychoose">
        <h3>Why Choose Our TikTok Reels Downloader?</h3>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="faq3">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3">
                        Is it legal to download TikTok Reels?
                    </button>
                </h2>
    ...
    <div class="legal-text">
        <h3>Legal Note</h3>
        <p>Downloading TikTok Reels for personal use is generally acceptable, but ensure compliance with copyright
            laws.</p>
        <p>Our service is not affiliated with TikTok and should be used responsibly.</p>
    </div>
...
<script>
    document.getElementById('downloadForm').addEventListener('submit', function(event) {
        ...
        window.location.href = "{{ route('tiktok.download') }}?url=" + encodeURIComponent(urlInput.value);
...
<script>
    document.getElementById('downloadForm').addEventListener('submit', function(event) {
        ...
        if (!videoUrl) {
            errorMessage.innerText = "Please enter a TikTok video URL.";
            errorMessage.style.display = "block";
            return;
        }

        if (!videoUrl.includes("tiktok.com")) {
            errorMessage.innerText = "Invalid TikTok video URL. Please check and try again.";
            errorMessage.style.display = "block";
            return;
        }

        // Simulate an API call (replace with actual download logic)
        fetch(`https://your-backend-api.com/download?url=${encodeURIComponent(videoUrl)}`)
            .then(response => {
                if (!response.ok) {
