...
<div class="container">
    ...
    <h2 class="center">Facebook Video Downloader</h2>
    <form id="downloadForm">
        <div class="input-container">
            <input type="text" id="videoUrl" name="url" placeholder="Enter Facebook Video URL" required>
    ...
    <div class="whychoose">
        <h3>Why Choose Our Facebook Reels Downloader?</h3>
...
<script>
    document.getElementById('downloadForm').addEventListener('submit', function(event) {
        ...
        window.location.href = "{{ route('facebook.download') }}?url=" + encodeURIComponent(urlInput.value);
